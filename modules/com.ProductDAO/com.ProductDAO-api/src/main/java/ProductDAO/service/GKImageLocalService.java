...
/**
 * Provides the local service interface for GKImage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GKImageLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GKImageLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>ProductDAO.service.impl.GKImageLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the gk image local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link GKImageLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public GKImage addGKImage(GKImage gkImage);
	...
	public GKImage createGKImage(long GKImageId);
	...
	public GKImage deleteGKImage(GKImage gkImage);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public GKImage deleteGKImage(long GKImageId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GKImage fetchGKImage(long GKImageId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public GKImage getGKImage(long GKImageId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<GKImage> getGKImages(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public GKImage updateGKImage(GKImage gkImage);
