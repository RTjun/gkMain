...
/**
 * Provides the local service utility for Classify. This utility wraps
 * <code>ProductDAO.service.impl.ClassifyLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ClassifyLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>ProductDAO.service.impl.ClassifyLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Classify addClassify(Classify classify) {
		return getService().addClassify(classify);
	}
	 ...
	 */
	public static Classify createClassify(long ClassifyId) {
		return getService().createClassify(ClassifyId);
	}
	 ...
	 */
	public static Classify deleteClassify(Classify classify) {
		return getService().deleteClassify(classify);
	}
	 ...
	 */
	public static Classify deleteClassify(long ClassifyId)
		throws PortalException {

		return getService().deleteClassify(ClassifyId);
	}
	...
	public static Classify fetchClassify(long ClassifyId) {
		return getService().fetchClassify(ClassifyId);
	}
	 ...
	 */
	public static List<Classify> getClassifies(int start, int end) {
		return getService().getClassifies(start, end);
	}
	 ...
	 */
	public static int getClassifiesCount() {
		return getService().getClassifiesCount();
	}
	 ...
	 * @throws PortalException if a classify with the primary key could not be found
	 */
	public static Classify getClassify(long ClassifyId) throws PortalException {
		return getService().getClassify(ClassifyId);
	}
	 ...
	 */
	public static Classify updateClassify(Classify classify) {
		return getService().updateClassify(classify);
	}

	public static ClassifyLocalService getService() {
		return _service;
	}

	private static volatile ClassifyLocalService _service;
