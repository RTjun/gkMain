...
/**
 * The persistence interface for the classify service.
 *
 * <p>
 ...
 */
@ProviderType
public interface ClassifyPersistence extends BasePersistence<Classify> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ClassifyUtil} to access the classify persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<Classify> classifies);
	 ...
	 */
	public java.util.List<Classify> findAll();
	 ...
	 */
	public java.util.List<Classify> findAll(int start, int end);
	...
	public java.util.List<Classify> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Classify>
			orderByComparator);
