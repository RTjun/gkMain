...
/**
 * Provides the local service utility for Norm. This utility wraps
 * <code>ProductDAO.service.impl.NormLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NormLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>ProductDAO.service.impl.NormLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Norm addNorm(Norm norm) {
		return getService().addNorm(norm);
	}
	 ...
	 * @return the new norm
	 */
	public static Norm createNorm(long NormId) {
		return getService().createNorm(NormId);
	}
	 ...
	 */
	public static Norm deleteNorm(long NormId) throws PortalException {
		return getService().deleteNorm(NormId);
	}
	 ...
	 * @return the norm that was removed
	 */
	public static Norm deleteNorm(Norm norm) {
		return getService().deleteNorm(norm);
	}
	...
	public static Norm fetchNorm(long NormId) {
	 ...
	 * @throws PortalException if a norm with the primary key could not be found
	 */
	public static Norm getNorm(long NormId) throws PortalException {
		return getService().getNorm(NormId);
	}
	 ...
	 */
	public static List<Norm> getNorms(int start, int end) {
		return getService().getNorms(start, end);
	}
	 ...
	 */
	public static int getNormsCount() {
		return getService().getNormsCount();
	}
	 ...
	 */
	public static Norm updateNorm(Norm norm) {
		return getService().updateNorm(norm);
	}

	public static NormLocalService getService() {
		return _service;
	}

	private static volatile NormLocalService _service;
